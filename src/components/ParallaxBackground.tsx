...
interface ParallaxBackgroundProps {
  isSectionFade?: boolean;
}

export default function ParallaxBackground({ isSectionFade = false }: ParallaxBackgroundProps) {
  ...
  return (
    <div className={`fixed inset-0 pointer-events-none -z-10 overflow-hidden bg-transparent transition-opacity duration-300 ${isSectionFade ? 'opacity-0' : 'opacity-100'}`}>
      {/* 
