...
const SHORTS_YOUTUBE_URL_1 = "https://youtube.com/shorts/e5xvJuqP77w?feature=share";
const SHORTS_YOUTUBE_URL_2 = "https://youtube.com/shorts/hbhx2WYYP4c?feature=share";
const SHORTS_YOUTUBE_URL_3 = "https://youtube.com/shorts/QABrJ2FlA78?feature=share";
...
const shorts = [
  ...
  { 
    ...
    localThumb: '/Images/thumbnail for short form/short3.avif'
  }
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-black/15 transition-colors group-hover:bg-black/15" />

        {/* Play Icon Overlay */}
        {isCenter && !isPlaying && (
          <div 
            className="absolute inset-0 flex items-center justify-center bg-black/20 group-hover:bg-black/20 transition-colors duration-300 pointer-events-auto cursor-pointer z-30"
            onClick={(e) => {
              e.stopPropagation();
              onPlay();
