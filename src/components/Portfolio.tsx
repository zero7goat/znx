...
const projects = [
  { 
    id: 'm1', 
    title: 'WORK 01', 
    videoUrl: 'https://youtu.be/ONY3EjuIqDA?si=KLGumR91qZyhMNqX',
    localThumb: '/Images/thumbnail for long form/thumb1.avif'
  },
  { 
    id: 'm2', 
    title: 'WORK 02', 
    videoUrl: 'https://youtu.be/ONE7tvJLuFs?si=43CKn0lsdmZrHdRM',
    localThumb: '/Images/thumbnail for long form/thumb2.avif'
  },
  { 
    id: 'm3', 
    title: 'WORK 03', 
    videoUrl: 'https://youtu.be/hJwTbpZp8pM?si=C3ovbFUbXSIsZQwg',
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Custom Perfect YouTube Play Button - not red, not big - turns #fb5d30 on hover - active on center slide */}
        {isCenter && (
...
export default function Portfolio({ activeVideoId, setActiveVideoId }: PortfolioProps) {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(([entry]) => {
      if (!entry.isIntersecting && activeVideoId && ['m1', 'm2', 'm3'].includes(activeVideoId)) {
        setActiveVideoId(null);
      }
    }, { threshold: 0.1 });
